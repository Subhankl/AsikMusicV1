            ...
            [
                [
                    InlineKeyboardButton(
                        "❤️‍🔥 Məni qrupa əlavə et ❤️‍🔥", url=f"https://t.me/TTKMusic_bot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "🇦🇿 𝖢𝗁𝖺𝗇𝗇𝖾𝗅", url="https://t.me/TTK_resmi"
                    )
                ],
                [
                    InlineKeyboardButton(
...
async def herkes(_, query: CallbackQuery):
    ...
    reply_markup=InlineKeyboardMarkup(
             [
                 [
                     InlineKeyboardButton(
                         "🇹🇷 𝖠𝗌𝗂𝗌𝗍𝖺𝗇", url="https://t.me/TTKAsistant"
                     ),
                     InlineKeyboardButton(
                         "🧑🏻‍💻 𝖮𝗐𝗇𝖾𝗋", url="https://t.me/FRESTYSHT"
                     )
                 ],
                 [
                     InlineKeyboardButton(
    ...
    await query.edit_message_text(f"""● **𝖬𝖾𝗋𝗁𝖺𝖻𝖺** {query.from_user.mention} \n\n● **𝖡𝖾𝗇** {bot} !\n\n● **𝖲𝖾𝗌𝗅𝗂 𝖲𝗈𝗁𝖻𝖾𝗍𝗅𝖾𝗋𝖽𝖾 müzik 𝖢𝖺𝗅𝖺𝖻𝗂𝗅𝖾𝗇 𝖡𝗈𝗍𝗎𝗆 . . !** \n\n● **𝖡𝖺𝗇 𝖸𝖾𝗍𝗄𝗂𝗌𝗂𝗓, 𝖲𝖾𝗌 𝖸𝗈𝗇𝖾𝗍𝗂𝗆 𝖸𝖾𝗍𝗄𝗂𝗌𝗂 𝗏𝖾𝗋𝗂𝗉 𝖠𝗌𝗂𝗌𝗍𝖺𝗇𝗂 𝖦𝗋𝗎𝖻𝖺 𝖤𝗄𝗅𝖾𝗒𝗂𝗇 . . !**""",
         reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🎉 𝖡𝖾𝗇𝗂 𝖦𝗋𝗎𝖻𝖺 𝖤𝗄𝗅𝖾 🎉", url=f"https://t.me/TTKMusic_bot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "🇹🇷 𝖢𝗁𝖺𝗇𝗇𝖾𝗅", url=f"https://t.me/TTK_resmi"
                    )
                ],
                [
                    InlineKeyboardButton(
